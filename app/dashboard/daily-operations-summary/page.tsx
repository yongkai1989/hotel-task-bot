      ...
      <section className="panel variance-panel">
        ...
        <div className="variance-layout">
          ...
          <section className="variance-section monthly-watch">
            <div className="variance-section-heading"><div><span>MONTHLY REPEAT WATCH</span><strong>Top 5 most frequently flagged</strong></div><small>{formatDate(linenAreaVariance?.month_start)} – {formatDate(linenAreaVariance?.month_end)}</small></div>
