      ...
      <section className="panel">
        ...
        <div className="reconciliation-grid">
          ...
          <section className="reconciliation-card return-card">
            <div className="reconciliation-heading"><div><strong>Today&apos;s Return − yesterday&apos;s In Bill</strong><span>Bill date: {formatDate(summary?.linen?.previous_bill_service_date)} - returned today for that bill</span></div><small>Positive means today&apos;s return is higher; negative means yesterday&apos;s In Bill is higher.</small></div>
