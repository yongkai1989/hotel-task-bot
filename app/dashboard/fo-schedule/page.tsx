...
export default function FrontOfficeSchedulePage(){
  ...
  return <main className={styles.page}>
    <section className={styles.hero}><div><span className={styles.eyebrow}>FRONT OFFICE WORKFORCE</span><h1>Front Office Schedule</h1><p>Manual monthly roster with coverage guidance and 15-hour shift-change rest checks.</p></div>
