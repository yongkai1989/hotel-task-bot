...
const displayStyles: Record<string, any> = {
  displayPage: {
    ...
    background:
      'radial-gradient(circle at 12% 0%, rgba(239,226,200,.8), transparent 30%), radial-gradient(circle at 98% 92%, rgba(249,238,216,.9), transparent 32%), linear-gradient(135deg, #f8f4ea, #f5f8fc)',
    color: '#172033',
    fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
  },
  backButton: {
    ...
    right: 14,
    zIndex: 10,
    border: '1px solid rgba(111,71,29,.28)',
    borderRadius: 999,
  ...
  sheet: {
    height: 'calc(100dvh - clamp(16px, 2.6vw, 28px))',
    maxWidth: 1320,
    margin: '0 auto',
    ...
    boxShadow: '0 28px 80px rgba(47,38,23,.12)',
    display: 'flex',
  ...
  tableHeader: {
    ...
    alignItems: 'center',
    minHeight: 'clamp(34px, 4.4vh, 42px)',
  ...
  row: {
    ...
    gridTemplateColumns: '1.4fr repeat(4, 1fr)',
    alignItems: 'center',
    minHeight: 'clamp(33px, 4.4vh, 40px)',
    borderBottom: '1px solid #ece3d4',
  },
  roomCell: {
    padding: '4px clamp(9px, 1.3vw, 18px)',
    minWidth: 0,
  },
  roomName: {
    display: 'block',
    color: '#071426',
    fontSize: 'clamp(12px, 1.18vw, 15px)',
    fontWeight: 950,
    letterSpacing: '-.02em',
    lineHeight: 1.1,
  },
  ...
  rateCell: {
    padding: '4px clamp(6px, .9vw, 12px)',
    textAlign: 'center',
    color: '#03152d',
